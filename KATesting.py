...
infile = open(r'C:/Users/Asif Towheed/Documents/DEVEL/Gait_Recognition/DOF/trained-model.pkl','rb')
clf = pickle.load(infile)

for i in os.listdir(r'C:\Users\Asif Towheed\Documents\DEVEL\Gait_Recognition\DOF'):                                          # open each walk for recorded person
    walks = []                                              # array to store how many times they have walked
    label_path = r'C:\Users\Asif Towheed\Documents\DEVEL\Gait_Recognition\DOF'.replace('\\','/') + '/' + i                          # path to that person        
